...
function init() {
    ...
    var center = new google.maps.LatLng(6.443873, 3.458682);
...
},
{
    ...
    var locations = [
        ['<h6>Bondi Beach, East Coast</h6><p>This is where we are currently, the sun goes down...<br><i class="fa fa-coffee"></i> Visit us, we pay the coffee!</p>', 6.443873, 3.458682, 1],
